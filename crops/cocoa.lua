...
-- bar of after eight (chocolate with mint)
minetest.register_craftitem("farming:chocolate_after_eight", {
	description = S("Bar of After Eight Chocolate"),
	inventory_image = "farming_chocolate_after_eight.png",
	on_use = minetest.item_eat(3)
})

minetest.register_craft( {
	output = "farming:chocolate_after_eight",
    type = "shapeless",
	recipe = {
		"group:food_cocoa", "group:food_cocoa",
        "group:food_cocoa", "group:food_mint"
	}
})

-- cocoa with milk glass
minetest.register_node("farming:cocoa_glass", {
	description = S("Glass of Cocoa with Milk"),
	drawtype = "plantlike",
	tiles = {"farming_cocoa_milk_glass.png"},
	inventory_image = "farming_cocoa_milk_glass.png",
	wield_image = "farming_cocoa_milk_glass.png",
	paramtype = "light",
	walkable = false,
	selection_box = {
		type = "fixed",
